                 ...
                 if(isset($_SESSION["SessionUsername"])){
                        ...
                        $row = mysqli_fetch_row($result);
                            ...
                            if($row[2] != "placeholder")
                            {
                                ...
                                echo "<button id=\"favonebutton\" name = \"favtwoname\">'$row[2]'</button>";
                            ...
                            if($row[3] != "placeholder")
                            {
                                ...
                                echo "<button id=\"favonebutton\" name = \"favthreename\">'$row[3]'</button>";
                        ...
                        //click favourite button to call a function
