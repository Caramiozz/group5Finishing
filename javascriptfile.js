...
function translateButton()
{
    ...
    ///
    ///Print functions
    if(document.getElementById("languageTranslateFrom").value == 'Java' && document.getElementById("methodName").value =="Print")
    {
        JavaToOtherLanguagesPrint();
    }
    else if(document.getElementById("languageTranslateFrom").value == 'C#' && document.getElementById("methodName").value =="Print")
    {
    ...
    else if(document.getElementById("languageTranslateFrom").value == 'Python' && document.getElementById("methodName").value =="Print")
    {
